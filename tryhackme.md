...
|              flag              |                                           説明                                            |
| ------------------------------ | ----------------------------------------------------------------------------------------- |
| --enumerate p                  | プラグインを列挙する                                                                      |
| --enumerate t                  | テーマを列挙する                                                                          |
| --enumerate u                  | ユーザー名を列挙する                                                                      |
| --enumerate vp                 | WPVulnDBを使用して、脆弱性を相互参照します。コマンドの例は脆弱なプラグインを探します（p） |
| --plugins-detection aggressive | これは、WPScanが使用する攻撃性プロファイルです。                                          |
